...
hl("BlinkCmpKindFunction",        { fg = colors.fun })
hl("BlinkCmpKindMethod",          { fg = colors.fun })
hl("BlinkCmpKindConstructor",     { fg = colors.special1 })
...
hl("BlinkCmpKindField",           { fg = colors.identifier })
hl("BlinkCmpKindProperty",        { fg = colors.identifier })
hl("BlinkCmpKindKeyword",         { fg = colors.keyword })
hl("BlinkCmpKindModule",          { fg = colors.preproc })
